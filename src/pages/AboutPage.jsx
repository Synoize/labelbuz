      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight">
            ...
            <span className="text-brand-600 dark:text-brand-400">Brands</span>
          </h1>
          <p className="mt-4 text-base sm:text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
            LabelBuz was built on a single premise: in today's fast-moving
            digital economy, standard marketing is dead. Only brands that fuse
            cutting-edge AI technology, irresistible visual craft, and
            data-driven ad performance win long term.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-8 items-stretch mb-20">
          ...
          >
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(rgba(167,139,250,.35) 1px, transparent 1px), linear-gradient(90deg, rgba(167,139,250,.35) 1px, transparent 1px)",
              ...
              <div className="flex items-center gap-5 py-10">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-sm text-sm leading-relaxed text-slate-300">
                    A compact team of strategists, designers, developers, and
                    growth specialists building brands people remember.
                  </p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <div className="p-8 rounded-3xl glass-card border border-slate-200 dark:border-slate-800 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
              To empower ambitious startups, growing enterprises, and
              established creators with complete end-to-end digital
              infrastructure—from AI video production and automated CRM
              workflows to custom web/mobile platforms and high-ROAS paid
              advertising.
            </p>
          </div>
          ...
          <div className="p-8 rounded-3xl glass-card border border-slate-200 dark:border-slate-800 space-y-4">
            ...
            <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white">
              The LabelBuz Difference
            </h2>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
              We don't sell bloated monthly retainers without accountability.
              Every project we launch carries strict performance KPIs: user
              conversion rate, sub-second load times, ad ROAS multiplier, and
        ...
        <div className="mb-20">
          <div className="mb-10 max-w-2xl">
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-brand-600 dark:text-brand-400">
              One connected team
            </span>
            <h2 className="mt-3 text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-4xl">
              Four capabilities, one growth engine.
            </h2>
            <p className="mt-3 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
              Every engagement connects the story you tell with the experience
              you build and the results you measure.
            </p>
          </div>
            ...
            {[
              {
                icon: BrainCircuit,
                title: "AI & Automation",
                text: "Remove repetitive work and create faster customer journeys.",
              },
              {
                icon: Palette,
                title: "Brand & Creative",
                text: "Turn a clear point of view into a visual identity that travels.",
              },
              {
                icon: Code2,
                title: "Digital Products",
                text: "Build quick, useful web and mobile experiences for real users.",
              },
              {
                icon: BarChart3,
                title: "Performance Growth",
                text: "Use clean data and smart campaigns to compound momentum.",
              },
        ...
        <div className="max-w-4xl mx-auto p-8 rounded-3xl glass-card border border-slate-200 dark:border-slate-800 mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div
                key={idx}
                className="flex items-center gap-3 p-3 rounded-2xl bg-slate-100/60 dark:bg-slate-800/60 text-xs font-semibold"
              >
