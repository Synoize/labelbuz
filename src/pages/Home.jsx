  ...
  const steps = [
    {
      ...
      desc: "We deep-dive into your business objectives and map an actionable growth strategy.",
    },
    {
      icon: Layers,
      title: "Build the Stack",
      desc: "Design, develop, and automate across every digital channel your brand needs.",
    },
    {
      icon: BarChart3,
      title: "Track & Optimise",
      desc: "Real-time dashboards and weekly reports keep you in full control of KPIs.",
    },
    {
      icon: Award,
      title: "Get Certified Results",
      desc: "Measurable ROI, published case studies, and a portfolio of proven wins.",
    },
    {
      icon: Rocket,
      title: "Scale to New Heights",
      desc: "Apply compounding growth across paid ads, content, and product channels.",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed mb-8">
              We believe every business deserves world-class digital execution.
              LabelBuz brings expert strategists, elite developers, and creative
              storytellers together to help you build skills that matter — and
              brands that last.
            </p>
...
function WorkSmarter({ onOpenContact }) {
  const features = [
    ...
    {
      icon: ShieldCheck,
      text: "Transparent reporting with full ownership of assets",
    },
  ];
