  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <motion.button
        ...
        className="w-14 h-14 rounded-full bg-brand-600 text-white shadow-soft-glow flex items-center justify-center border-2 border-white/40 dark:border-slate-800 backdrop-blur-md transition-all duration-300 group"
        aria-label="Customize Theme Colors"
      >
        <Palette className="w-6 h-6 group-hover:rotate-45 transition-transform duration-300" />
      </motion.button>
